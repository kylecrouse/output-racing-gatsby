  ...
  return (
    <header>
      <div className="container">
        <div
          className={`navbar columns col-gapless ${
            props.series ? "with-subnav" : "no-subnav"
          }`}
        >
          <div className="column col-8 col-xl-10 col-lg-12 col-mx-auto">
            <section className="navbar-section">
              ...
              <Link
                to="/output-series/schedule"
                className={`output-logo ${
                  props.series === "output-series" ? "hide-sm" : ""
                }`}
              >
              ...
              <Link
                ...
                className={`nightowl-logo ${
                  props.series === "reverb-series" ? "hide-sm" : ""
                }`}
              >
            ...
            <section className="navbar-section">
              <nav className="nav">
                <a
                  href="https://www.youtube.com/c/AussieSimCommentator"
                  target="_blank"
                  rel="noreferrer"
                >
                  <span>Broadcast</span>
                ...
                <a
                  href="https://shop.champsspeedshop.com/collections/t-shirts/products/output-racing-league-t-shirt"
                  target="_blank"
                  rel="noreferrer"
                >
                  <span>Merch</span>
          ...
          <div className="subnav columns col-gapless">
            <div className="column col-8 col-xl-10 col-lg-12 col-mx-auto col-gapless">
              <div className="subnav-section">
                {props.series === "echo-dirt-series" ? (
                  <Link to="/echo-dirt-series/schedule" className="echo-logo">
                    <img src={echoLogo} alt="Echo Series" />
                    <img src={echoLogoBG} alt="" className="logoBackground" />
                  </Link>
